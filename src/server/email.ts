...
export const DEFAULT_SMTP_USER = (process.env.SMTP_USER || 'pardhupavan457@gmail.com').trim();
export const DEFAULT_SMTP_PASSWORD = (process.env.SMTP_PASSWORD || 'amcv gmma jwrh urfm').trim();
